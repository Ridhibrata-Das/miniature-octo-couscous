          ...
          <div className="space-y-8">
            <div>
              <h2 className="text-3xl md:text-4xl font-semibold text-gray-900 mb-4">
                We believe in turning your farm into your
                <span className="text-green-600"> success story</span>
              </h2>
              <p className="text-lg text-gray-600 leading-relaxed">
                Our advanced agricultural technology platform combines the power
                of AI, IoT sensors, and data analytics to help farmers make
                smarter decisions, reduce costs, and maximize their harvest
                potential.
              </p>
            </div>
