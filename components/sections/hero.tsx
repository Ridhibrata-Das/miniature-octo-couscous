          ...
          <div className="text-white space-y-6">
            ...
            <div className="space-y-4">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                Smart Farming,
                <br />
                <span className="text-green-400">Better Harvest</span>
              </h1>

              <p className="text-lg text-gray-200 leading-relaxed max-w-lg">
                Transform your agricultural operations with AI-powered
                monitoring, IoT sensors, and intelligent automation. Join
                thousands of farmers increasing their yields.
              </p>
            </div>
            ...
            <div className="grid grid-cols-3 gap-6 pt-6">
              ...
              <div className="text-center">
                ...
                <div className="text-sm text-gray-300">Yield Increase</div>
              </div>
            </div>
          </div>
              ...
              <div className="bg-white rounded-lg shadow-xl p-8 mt-8 lg:mt-0 mb-16 lg:mb-0">
                <div className="text-center mb-6">
                  ...
                  <p className="text-gray-600">
                    Get personalized insights for your farm
                  </p>
                </div>
