        ...
        <div className="bg-green-600 rounded-lg p-8 text-white text-center">
          <div className="max-w-3xl mx-auto">
            <div className="flex items-center justify-center mb-4">
              ...
              <h3 className="text-2xl font-bold">Balram AI</h3>
            </div>
            <h4 className="text-xl font-semibold mb-4">
              Ask Any Farming Question, Get Expert Answers
            </h4>
            <p className="text-green-100 mb-6 leading-relaxed">
              24/7 AI assistant trained on agricultural knowledge. Get instant
              advice on crop diseases, fertilizers, weather impacts, and farming
              best practices.
            </p>
